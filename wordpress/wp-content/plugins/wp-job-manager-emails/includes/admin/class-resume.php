...
class WP_Job_Manager_Emails_Admin_Resume extends WP_Job_Manager_Emails_Admin {

	/**
	 * WP_Job_Manager_Emails_Job_Admin constructor.
	 *
	 * @param $cpt WP_Job_Manager_Emails_CPT_Resume
	 */
	public function __construct( $cpt ) {

		$this->cpt       = $cpt;
		$this->help      = new WP_Job_Manager_Emails_Admin_Help_Resume( $cpt );
		$this->ajax      = new WP_Job_Manager_Emails_Admin_Ajax_Resume( $cpt );
		$this->settings  = new WP_Job_Manager_Emails_Admin_Settings_Resume( $cpt );
		$this->listtable = new WP_Job_Manager_Emails_Admin_ListTable_Resume( $cpt );
	...
	function init_pointers(){
		...
		$pointers = array(
			array(
				'id'       => 'jm-resume-emails-template-default-tab',
				'screen'   => 'jm_resume_emails',
			...
			array(
				'id'       => 'jm-resume-emails-sc-tab-pointer',
				'screen'   => 'jm_resume_emails',
			...
			array(
				'id'       => 'jm-resume-emails-templates-pointer',
				'screen'   => 'jm_resume_emails',
			...
			array(
				'id'       => 'jm-resume-emails-help-pointer',
				'screen'   => 'jm_resume_emails',
			...
			array(
				'id'       => 'jm-resume-emails-menu-item',
				'screen'   => 'all',
				'target'   => '#menu-posts-resume',
				'title'    => __( 'Email Templates', 'wp-job-manager-emails' ),
				'content'  => __( 'You can find Resume email templates here, under the Resumes main menu item.', 'wp-job-manager-emails' ),
				'position' => array(
