...
<div class="resume-meta-top row">
	...
	<div class="col-md-<?php echo 3 == $count ? '2' : $columns; ?> col-sm-4 col-xs-12">
		<?php
	...
	<div class="col-md-<?php echo 3 == $count ? '6' : $columns; ?> col-sm-8 col-xs-12">
		<?php
		if ( ! is_active_sidebar( 'single-resume-top-2' ) ) {	
			echo get_post_meta( $post->ID, '_candidate_industry', true ); echo "<br/><br/>";	
